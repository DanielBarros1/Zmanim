...
- **Room assignment is optional** in Milestone 1. The admin can assign a room to an entry, but it's not required. Specialized room restrictions still enforce their room when the room is known.
